...
def create_map(view_type, selected_year=None, selected_date_str=None, crime_data=None, indicator_data=None, prediction_data=None, geo_data=None):
    selected_date = pd.to_datetime(selected_date_str) if selected_date_str else None
...
with st.spinner("맵을 로드하는 중..."):
    ...
    combined_map, combined_title = create_map(
        view_type, selected_year, selected_date_str,
